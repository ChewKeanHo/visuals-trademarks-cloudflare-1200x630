# Cloudflare Trademarks Logo 1200x630 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x630.svg)](#)

The Cloudflare Trademarks Logo. They published a full and clear guidelines for
deployment and supplied some material files for it. However, its provided
files for referencing was a rasterized JPEG or PNG images which are very
unfeasible when it comes to website deployment. The preferred version is `.svg`
which has non-destructive scale up & down properties and can be converted into
any rasterized images (e.g. `jpeg`, `webp`, `avif`, etc). Hence, a re-draw is
required.

This project re-draws Cloudflare Trademarks Logo specifically for 1200x630 size.
...
Please read through Cloudflare's Trademark Engineering Specification
(https://www.cloudflare.com/trademark/) before editing to avoid any unwanted
legal implications.

While not specified by Cloudflare, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: Cloudflare Trademarks Logo 1200x630
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-cloudflare-1200x630
UUID: C3B9067A-8C2D-4C0B-AC2C-69C8C48F3454
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-01-14
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-cloudflare-1200x630
--------------------------------------------------------------------------------
```
...
> COMPLY WITH CLOUDFLARE TRADEMARK REQUIREMENTS
> (Read: https://www.cloudflare.com/trademark)**.
>
